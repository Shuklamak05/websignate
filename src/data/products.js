export const products = [
  ...
  },
  {
    ...
    indications: ["Atopic Dermatitis & Pruritus", "Excessive Fur Shedding", "Flaky Skin & Dandruff Control", "Allergic Skin Sensitivity", "Dull/Brittle Hair Coat Restoration"],
    ingredients: [
      "Type I & III Bioactive Collagen Peptides",
  ...
  },
  {
    ...
    indications: ["Acute & Chronic Diarrhea", "Antibiotic-Associated Gut Dysbiosis", "Gastrointestinal Gas, Bloating & Flatulence", "Malabsorption Syndrome", "Poor Appetite & Digestive Stress Recovery"],
    ingredients: [
  ...
  },
  {
    ...
    indications: ["Separation & Environmental Noise Anxiety", "Chronic Joint Discomfort & Inflammatory Arthritic Pain", "Allergic Atopy & Intense Pruritus", "Excessive Hair Coat Shedding", "Dry, Damaged Skin Conditions"],
    ingredients: [
  ...
  },
  {
    ...
    indications: ["Weakened Immune System Support", "Infectious Pathogen Recovery Support", "Post-Surgical Immunity Protection", "Chronic Secondary Illness Reduction", "Geriatric Vitality Decline Management"],
    ingredients: [
      "Algal 1",
      "3 Beta-glucans",
      "Fructooligosaccharides (FOS)",
  ...
  },
  {
    ...
    indications: ["Cognitive Dysfunction Syndrome (CDS)", "Geriatric Osteoarthritis & Muscle Wasting", "Age-Related Cardiac and Visual Decline", "Senior Digestive Dysfunction", "Chronic Urinary Tract Vulnerability"],
    ingredients: [
  ...
  },
  {
    ...
    indications: ["Age-Related Behavioral Alterations (CDS)", "Environmental & Separation Anxiety", "Geographic Disorientation", "Restlessness, Pacing & Vocalization", "Training Focus Enhancement"],
    ingredients: [
      "Standardized Brahmi Extract",
  ...
  },
  {
    ...
    indications: ["Maternal Prenatal Conditioning", "Fetal Developmental Support", "Postpartum Lactation Boosting", "Prevention of Maternal Calcium Exhaustion", "Neonatal Birth Weight Maximization"],
    ingredients: [
  ...
  },
  {
    ...
    indications: ["Male Stud Infertility Resolution", "Low Sperm Count (Oligospermia) Correction", "Poor Sperm Motility Support", "Breeding Libido & Stamina Stimulation", "Mating Responsiveness Optimization"],
    ingredients: [
      "Standardized Ashwagandha Extract",
  ...
  },
  {
    ...
    indications: ["Irregular/Absent Estrus Cycle Correction", "Sub-Optimal Ovulation Output Support", "Poor Oocyte (Egg) Quality Resolution", "Early Embryonic Loss Prophylaxis", "Uterine Vascular Flow Maximization"],
    ingredients: [
      "Standardized Ashwagandha Extract",
      "Standardized Shatavari Extract",
      "L-Arginine Base",
  ...
  },
  {
    ...
    indications: ["Infected open wounds and abscesses", "Post-Surgical Incision Healing", "Acute Cuts, Lacerations & Skin Abrasions", "Bite Wounds & Interdigital Dermatitis", "Moist Eczema (Hot Spots) Recovery"],
    ingredients: [
  ...
  },
  {
    ...
    indications: ["Non-Healing, Chronic Decubitus Ulcers", "Severe Traumatic/Infected Body Wounds", "Major Orthopedic/Soft-Tissue Post-Op Healing", "Extensive Dermal Burns & Tissue Loss Recovery", "Aged Pets with Slow Healing Capacity"],
    ingredients: [
      "L-Arginine Base",
      "L-Glutamine Base",
  ...
  },
  {
    ...
    indications: ["Lactation Optimization", "Reproductive Efficiency", "Fertility Enhancement", "Herd Immunocompetency", "Sub-clinical Deficiency Prevention"],
    ingredients: [
      "Zinc glycinate",
      "Copper glycinate",
      "Manganese glycinate",
  ...
  },
  {
    ...
    indications: ["Advanced Rumen Management", "Sub-Acute Ruminal Acidosis (SARA) Prevention", "Total Mixed Ration (TMR) Efficiency", "Immune Resilience", "Hepatic Optimization"],
    ingredients: [
      "Copper glycinate",
      "Zinc glycinate",
      "Manganese glycinate",
  ...
  },
  {
    ...
    indications: ["Peak-Lactation Metabolic Support", "Negative Energy Balance (NEB) Management", "Advanced Amino Acid Balancing", "High-Volume Fat & Protein Correction", "Hoof and Foot Health Optimization"],
    ingredients: [
      "Copper glycinate",
      "Zinc glycinate",
      "Manganese glycinate",
  ...
  },
  {
    ...
    indications: ["Basal Diet Fortification", "Cost-Effective Herd Mineralization", "Lactation Curve Maintenance", "General Skin & Coat Health"],
    ingredients: [
      "Zinc",
      "Copper",
      "Manganese",
  ...
  },
  {
    ...
    indications: ["Commercial Compound Feed Formulation", "High-Concentrate TMR Self-Mixing", "Skeletal and Hoof Structural Integrity", "Industrial-Scale Herd Optimization"],
    ingredients: [
      "Copper glycinate",
      "Zinc glycinate",
      "Manganese glycinate",
  ...
  },
  {
    ...
    indications: ["Large-Scale Commercial Feed Milling", "Concentrated Mineral Block Manufacturing", "High-Volume Corporate Integration"],
    ingredients: [
      "Copper glycinate",
      "Zinc glycinate",
      "Manganese glycinate",
  ...
  },
  {
    ...
    indications: ["Pre-Calving Transition Management", "Hypocalcemia (Milk Fever) Prevention", "Ketosis and Fatty Liver Prophylaxis", "Placental Expulsion Optimization"],
    ingredients: [
  ...
  },
  {
    ...
    indications: ["Postpartum Energy Optimization", "Negative Energy Balance Mitigation", "Clinical/Subclinical Ketosis Prevention", "Early Uterine Involution Support"],
    ingredients: [
      "Calcium propionate",
      "Rumen-Protected (RP) Choline",
      "Pure Niacin",
  ...
  },
  {
    ...
    indications: ["Acute Hypocalcemia Prevention", "Peak Lactation Volumetric Stimulation", "Postpartum Stress Recovery", "Skeletal Integrity Reinforcement"],
    ingredients: [
      "Ionic Calcium",
  ...
  },
  {
    ...
    indications: ["Total Mixed Ration Decontamination", "Aflatoxin M1 Milk Contamination Prevention", "Intestinal Mucosal Protection", "Feed Efficiency Stabilization"],
    ingredients: [
  ...
  },
  {
    ...
    indications: ["Severe or Variable Feed Mold Contamination", "Non-Polar Toxin Neutralization", "Bacterial Endotoxemia Defense", "Acute Enteric Toxemia Recovery"],
    ingredients: [
  ...
  },
  {
    ...
    indications: ["High-Concentrate/Low-Forage Diet Management", "Sub-Acute Ruminal Acidosis (SARA) Prevention", "Milk Fat Depression Correction", "Heat Stress Acidosis Mitigation"],
    ingredients: [
  ...
  },
  {
    ...
    indications: ["Postpartum Silent Anestrus Treatment", "Repeat Breeder Syndrome Resolution", "Estrus Synchronization Support", "Early Embryonic Mortality Prevention"],
    ingredients: [
  ...
  },
  {
    ...
    indications: ["Heat Stress Performance Management", "Fiber Digestibility Optimization", "Dry Matter Intake Stabilization", "Lactation Consistency Support"],
    ingredients: [
      "Chromium propionate",
  ...
  },
  {
    ...
    indications: ["Clinical Mastitis Treatment Co-Therapy", "Sub-Clinical Mastitis Somatic Management", "Somatic Cell Count (SCC) Reduction", "Mammary Secretory Tissue Restoration"],
    ingredients: [
      "Trisodium Citrate",
  ...
  },
  {
    ...
    indications: ["High-Fiber Crop Utilization Enhancement", "Feed Conversion Ratio (FCR) Optimization", "Low-Cost Ration Formulation Supporting Performance", "Starch and Cellulose Breakdown Catalysis"],
    ingredients: [
      "Xylanase",
      "Cellulase",
      "Mannanase",
  ...
  },
  {
    ...
    indications: ["Acute/Sub-Acute Acidosis Prevention", "Rumen Microflora Stabilization", "Dry Matter Intake Stimulation", "Fiber Conversion Optimization"],
    ingredients: [
  ...
  },
  {
    ...
    indications: ["Unpalatable Feed/Byproduct Masking", "Ration Sortation and Waste Prevention", "Stress/Ration Change Appetite Stimulation", "Feed Palatability Standardization"],
    ingredients: [
  ...
  },
  {
    ...
    indications: ["Neonatal Calf Scours Prevention", "Average Daily Weight Gain Optimization", "Rumen Papillary Development Support", "Weaning Transition Stress Management"],
    ingredients: [
      "Lactobacillus acidophilus",
      "Lactobacillus casei",
      "Lactobacillus rhamnosus",
  ...
  },
  {
    ...
    indications: ["Feed Intolerance Mitigation", "Regional Preference Adaptation", "Aromatic Core Masking", "Commercial Brand Differentiation"],
    ingredients: [
      "Concentrated",
  ...
  },
  {
    ...
    indications: ["Green Fodder Silage Preservation", "Aerobic Heating Minimization at Feed-Out", "Dry Matter Loss Reduction", "Lactic-to-Acetic Acid Balance Optimization"],
    ingredients: [
